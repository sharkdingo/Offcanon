...
class SqliteIdentityRepositoryTest {
    ...
    void sessionSaveIsIdempotentForExactReplayAndRejectsDifferentContent() {
        ...
        SqliteSessionRepository repository = new SqliteSessionRepository(jdbc);
    ...
    void authSessionSaveIsIdempotentAndRejectsTokenIdentityConflict() {
        ...
        SqliteAuthSessionRepository repository = new SqliteAuthSessionRepository(jdbc);
    ...
    void projectSaveDistinguishesIdempotentReplayIdentityConflictAndCanonicalDuplicate() {
        ...
        SqliteProjectRepository replayRepository = new SqliteProjectRepository(replayJdbc, new ObjectMapper());
        ...
        SqliteProjectRepository canonicalRepository = new SqliteProjectRepository(canonicalJdbc, new ObjectMapper());
        ...
        SqliteProjectRepository sameIdByPathRepository = new SqliteProjectRepository(sameIdByPathJdbc, new ObjectMapper());
