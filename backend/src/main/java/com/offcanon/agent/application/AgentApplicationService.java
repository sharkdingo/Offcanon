...
public class AgentApplicationService {
    ...
    public AgentApplicationService(ExperimentRepository experimentRepository,
        ...
        this(experimentRepository, projectRepository, snapshotRepository, snapshotPort, agentLoop,
                verification, agentExecutor, events, sessionRunLease, workspaces, null);
    }
    ...
    private void run(UUID experimentId, AtomicBoolean cancellation) {
        ...
        try {
            ...
            AgentRunResult result = settings.isPresent()
                    ? agentLoop.run(experiment, cancellation::get, sessionContext(experiment), settings.orElseThrow())
                    : agentLoop.run(experiment, cancellation::get, sessionContext(experiment));
