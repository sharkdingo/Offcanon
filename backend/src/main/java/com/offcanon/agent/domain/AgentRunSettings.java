...
public record AgentRunSettings(int maxSteps,
    ...
    public static AgentRunSettings defaults(int maxSteps, long runTimeoutSeconds, int contextLimitChars) {
        return new AgentRunSettings(maxSteps, runTimeoutSeconds, contextLimitChars, "", "");
    }
